...
export default {
    ...
    async mounted() {
        try {
            ...
            // Inicializa o Flowbite
            initFlowbite();
            
            // Aguarda um tempo mínimo para melhor UX
            await new Promise(r => setTimeout(r, 1500));
            
            // Remove o loading apenas quando tudo estiver pronto
            this.loading = false;
            
            // Inicializa o modal e tabs após o loading
            this.initializeModalAndTabs();
        } catch (error) {
    ...
    methods: {
        initializeModalAndTabs() {
            // Seu código atual de inicialização de modal e tabs
